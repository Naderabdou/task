                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#"> {{ $category->name }} تعديل القسم</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                    href="{{ route('admin.categories.create') }}"><i class="mr-1"
                                        data-feather="check-square"></i><span class="align-middle">اضافة القسم
                                        جديد</span></a></div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group prev">
                                                    <img src="{{  asset('storage/' . $category->icon) }}" style="width: 100px"
